...
;(function ( $, window, document, undefined ) {
	...
	defaults = {
		...
		// messages
		placeholder: "1", // default placeholder when nothing is selected
	...
	Plugin.prototype = {
		...
		_init: function() {
			...
			this.ul = $('<ul class=\'scroll-pane\'>'+this._parseSelect()+'<li class="'+op.class_empty+'">'+op.empty+'</li></ul>').appendTo(this.wrapper);
